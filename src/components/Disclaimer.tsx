  ...
  return (
    ...
    >
      <AnimatePresence mode="wait">
        {isVisible && (
          <motion.div 
            className="bg-amber-50 border border-amber-200 rounded-2xl p-6 md:p-8 relative"
            initial={{ 
              opacity: 0, 
              y: 20, 
              scale: 0.95
          ...
          >
            ...
            <motion.button
              onClick={onClose}
              className="absolute top-4 right-4 px-4 py-2 bg-amber-100 text-amber-800 rounded-xl font-medium hover:bg-amber-200 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2"
